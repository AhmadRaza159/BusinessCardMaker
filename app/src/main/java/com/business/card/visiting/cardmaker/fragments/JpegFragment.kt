...
import kotlinx.android.synthetic.main.fragment_jpeg.view.*
import kotlinx.android.synthetic.main.fragment_pdf.view.*
import kotlinx.android.synthetic.main.fragment_pdf.view.empsec
import java.io.File
import java.util.*

class JpegFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var v= inflater.inflate(R.layout.fragment_jpeg, container, false)
        v.my_creation_image_recyclerview.layoutManager = LinearLayoutManager(context)

        /////////////////////
        datL.clear()
        for (i in getDownloadedFileList()){
            if (i.toString().toUpperCase().contains("JPEG")){
                datL.add(i)
            }
        }
        ...
        adapter = MyCreationAdapter(datL,true,requireContext(), object : DownloadedInterface {
...
//                    startActivity(Intent.createChooser(sharingIntent, "Share using"))
        ...
        v.my_creation_image_recyclerview.adapter = adapter
